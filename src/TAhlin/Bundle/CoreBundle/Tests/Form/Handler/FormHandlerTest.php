...
namespace TAhlin\Bundle\CoreBundle\Tests\Factory;

use TAhlin\Bundle\CoreBundle\Form\Handler\FormHandler;
use TAhlin\Bundle\CoreBundle\Tests\Entity\Dummy;
use TAhlin\Bundle\CoreBundle\Tests\Form\Type\DummyType;
use TAhlin\Bundle\CoreBundle\Exception\FormValidationException;
...
class FormHandlerTest extends KernelTestCase
{
     ...
     * @group form
     * @expectedException \TAhlin\Bundle\CoreBundle\Exception\FormHandlerException
     ...
     * @group form
     * @expectedException \TAhlin\Bundle\CoreBundle\Exception\FormValidationException
     */
